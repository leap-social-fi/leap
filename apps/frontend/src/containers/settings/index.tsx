import { IconCopy, IconEdit, IconLogout } from '@tabler/icons-react'
	...
	return (
		<div className="flex flex-col">
			<header className="sticky top-0 z-30 bg-charcoal/80 px-5 pt-12 pb-6 backdrop-blur-md">
				<div className="flex flex-col items-center gap-4">
					<div className="relative">
						...
						<div className="absolute right-0 bottom-0 cursor-pointer rounded-full border-2 border-charcoal bg-primary p-1.5">
							<IconEdit className="text-white" size={16} />
						</div>
					</div>
					<div className="flex flex-col items-center gap-2">
						<h1 className="font-bold text-xl tracking-tight">Alex Rivera</h1>
						<div className="flex items-center justify-center gap-2">
							<code className="rounded-full border border-slate-800 bg-surface-dark px-3 py-1 text-slate-400 text-xs">
								0x71C...3A94
							</code>
			...
			<main className="space-y-6 px-5 pb-32">
				<section>
					<h3 className="mb-3 ml-1 font-bold text-[10px] text-slate-500 uppercase tracking-[0.2em]">
						Account
					</h3>
					<div className="overflow-hidden rounded-2xl bg-surface-dark">
						<div className="flex w-full items-center justify-between border-white/5 border-b px-4 py-4 transition-colors active:bg-white/5">
				...
				<p className="mt-8 text-center font-bold text-[10px] text-slate-600 uppercase tracking-widest">
