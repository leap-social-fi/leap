...
const LandingPageContainer: React.FC = () => {
	return (
		<div className="min-h-screen text-slate-900 selection:bg-primary selection:text-white dark:bg-background-dark dark:text-white">
			<nav className="sticky top-0 z-50 border-slate-200 border-b backdrop-blur-md dark:border-slate-800 dark:bg-background-dark/80">
